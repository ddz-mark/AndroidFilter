...
public class BeautifyImageActivity extends BaseToolBarActivity {
    ...
    protected void customToolBarStyle() {
        ...
        MenuItem item = mToolbar.getMenu().findItem(R.id.preview_menu);
        Button button = (Button) item.getActionView().findViewById(R.id.activity_beautifu_complete);
...
//                                    fragment.complete();
    ...
    protected void initView() {
        ...
        mRlContainer = (RelativeLayout) findViewById(R.id.content_container);
        mHlvFilter = (HorizontalListView) findViewById(R.id.effect_listview);
    }
